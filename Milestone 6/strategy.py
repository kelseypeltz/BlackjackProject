...
class Strategy:
    ...
    def BestActionPolicyFromQTableDict(self, QTableDict, playerCardPoints, dealerCardPoints, playerCardUsableAce):
        ...
        if doubleValue > hitValue and doubleValue > stickValue:
            return 2
            ...
            if (method == "Q-Learning" or method == "Sarsa"):
                ...
                if i < len(occurredStateActions) - 1:
                    ...
                    if (method == "Q-Learning"):
                        ...
                        maxvalue = max(QTableDict[nextStateHitAction], QTableDict[nextStateStickAction], QTableDict[nextStateDoubleAction])
